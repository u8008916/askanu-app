...
export const needsClarificationManyOptionsResponse: AskResponse = {
  ...
  clarification: {
    ...
    options: [
      { id: 'course:COMP1100', label: 'COMP1100' },
      { id: 'course:COMP1110', label: 'COMP1110' },
      { id: 'course:COMP1130', label: 'COMP1130' },
      { id: 'course:COMP1600', label: 'COMP1600' },
      { id: 'course:COMP1710', label: 'COMP1710' },
      { id: 'course:COMP2100', label: 'COMP2100' },
      { id: 'course:COMP2600', label: 'COMP2600' },
    ],
